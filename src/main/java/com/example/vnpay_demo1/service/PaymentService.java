...
public class PaymentService {
    ...
    @SendTo()
    private PaymentRequest rabbitMQConsumer(PaymentRequest request) {
        try {
            Gson gson = new Gson();
    ...
    public Object getOnePayment(String bankcode, String tokenKey){
        Gson gson = new Gson();
        ...
        if (resultRedis == null){
            ...
            return rabbitMQConsumer(result);
        } else {
            return resultRedis;
        }
